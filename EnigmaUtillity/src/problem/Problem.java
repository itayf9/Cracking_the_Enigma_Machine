...
public enum Problem {
    ...
    UNKNOWN, NO_PROBLEM, NO_REFLECTOR_BEEN_CHOSEN, NO_LOADED_MACHINE, CIPHER_INPUT_EMPTY_STRING, FILE_TOO_MANY_AGENTS, FILE_TOO_LITTLE_AGENTS, INVALID_DIFFICULTY_LEVEL, BATTLEFIELD_NAME_ALREADY_EXIST, ALLIES_COUNT_LESS_THAN_1;
