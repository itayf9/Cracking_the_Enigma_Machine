...
public enum Problem {
    ...
    UBOAT_NAME_DOESNT_EXIST,
    MISSING_QUERY_PARAMETER,
    MORE_THAN_ONE_FILE,

    NOT_FOUND_UBOAT_NAME,
    BATTLEFIELD_NOT_CONFIGURED,
    ALLIE_NAME_NOT_FOUND_IN_BATTLEFIELD, BATTLEFIELD_ALREADY_CONFIGURED, NO_ALLIE_NAME, AGENT_NAME_DOESNT_EXIST, CONTEST_IS_FULL,
    ALLIE_NOT_SUBSCRIBED, MISSING_TASK_SIZE, MISSING_AGENTS_AMOUNT, NOT_ENOUGH_LOGGED_AGENTS, MISSING_NUM_OF_THREADS, MISSING_MISSION_COUNT, MISSING_TEXT_TO_CIPHER, MISSING_ALLIE_NAME, ALLIE_NAME_DOESNT_EXIST, UBOAT_LOGGED_OUT, UBOAT_LOGGED_OUT_OR_NOT_FOUND, ALLIE_LOGGED_OUT;


    public String problemToGeneralMessage() {
        switch (this) {
            case MISSING_QUERY_USERNAME:
                return "Please enter a username";
            case USERNAME_ALREADY_EXIST:
                return "This username already exists";
            case MISSING_ALLIE_NAME:
                return "Select a valid team";
            case MISSING_NUM_OF_THREADS:
                return "Select the number of threads";
            case MISSING_MISSION_COUNT:
                return "Select the number of tasks per pull";
            default:
                return "Error";
        }
    }
