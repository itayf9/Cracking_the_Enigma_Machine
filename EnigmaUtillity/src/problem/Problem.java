...
public enum Problem {
    ...
    USERNAME_ALREADY_EXIST, UBOAT_NAME_DOESNT_EXIST, MISSING_QUERY_PARAMETER, MORE_THAN_ONE_FILE, NOT_FOUND_UBOAT_NAME, ALLIE_NAME_NOT_FOUNT, BATTLEFIELD_NOT_CONFIGURED;
