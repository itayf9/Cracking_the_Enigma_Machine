...
public enum Problem {
    ...
    NOT_FOUND_UBOAT_NAME, BATTLEFIELD_NOT_CONFIGURED, ALLIE_NAME_NOT_FOUND, BATTLEFIELD_ALREADY_CONFIGURED, NO_ALLIE_NAME, AGENT_NAME_DOESNT_EXIST, CONTEST_IS_FULL, ALLIE_NOT_SUBSCRIBED;
