...
public enum Problem {
    ...
    ALLIE_NOT_SUBSCRIBED, MISSING_TASK_SIZE, MISSING_AGENTS_AMOUNT, NOT_ENOUGH_LOGGED_AGENTS, MISSING_NUM_OF_THREADS, MISSING_MISSION_COUNT, MISSING_TEXT_TO_CIPHER, MISSING_ALLIE_NAME, ALLIE_NAME_DOESNT_EXIST;
